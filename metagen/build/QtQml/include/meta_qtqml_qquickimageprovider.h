...
public:
    ...
    QPixmap requestPixmap(const QString & id, QSize * size, const QSize & requestedSize, bool requestedAutoTransform)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QPixmap >(cpgf::invokeScriptFunctionOnObject(func.get(), this, id, size, requestedSize, requestedAutoTransform).getValue());
        }
        return QQuickImageProvider::requestPixmap(id, size, requestedSize, requestedAutoTransform);
    }
    QPixmap super_requestPixmap(const QString & id, QSize * size, const QSize & requestedSize, bool requestedAutoTransform)
    {
        return QQuickImageProvider::requestPixmap(id, size, requestedSize, requestedAutoTransform);
    }
    
    QQuickTextureFactory * requestTexture(const QString & id, QSize * size, const QSize & requestedSize, bool requestedAutoTransform)
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("requestTexture"));
        if(func)
        {
            return cpgf::fromVariant<QQuickTextureFactory * >(cpgf::invokeScriptFunctionOnObject(func.get(), this, id, size, requestedSize, requestedAutoTransform).getValue());
        }
        return QQuickImageProvider::requestTexture(id, size, requestedSize, requestedAutoTransform);
    }
    QQuickTextureFactory * super_requestTexture(const QString & id, QSize * size, const QSize & requestedSize, bool requestedAutoTransform)
    {
        return QQuickImageProvider::requestTexture(id, size, requestedSize, requestedAutoTransform);
    }
    
    QImage requestImage(const QString & id, QSize * size, const QSize & requestedSize, bool requestedAutoTransform)
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("requestImage"));
        if(func)
        {
            return cpgf::fromVariant<QImage >(cpgf::invokeScriptFunctionOnObject(func.get(), this, id, size, requestedSize, requestedAutoTransform).getValue());
        }
        return QQuickImageProvider::requestImage(id, size, requestedSize, requestedAutoTransform);
    }
    QImage super_requestImage(const QString & id, QSize * size, const QSize & requestedSize, bool requestedAutoTransform)
    {
        return QQuickImageProvider::requestImage(id, size, requestedSize, requestedAutoTransform);
    }
    ...
    static void cpgf__register(D _d)
    {
        (void)_d;
        using namespace cpgf;
        _d.CPGF_MD_TEMPLATE _method("super_requestPixmap", (QPixmap (D::ClassType::*) (const QString &, QSize *, const QSize &, bool))&D::ClassType::super_requestPixmap, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<-1>, cpgf::GMetaRuleCopyConstReference<0> >());
        _d.CPGF_MD_TEMPLATE _method("super_requestTexture", (QQuickTextureFactory * (D::ClassType::*) (const QString &, QSize *, const QSize &, bool))&D::ClassType::super_requestTexture, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
        _d.CPGF_MD_TEMPLATE _method("super_requestImage", (QImage (D::ClassType::*) (const QString &, QSize *, const QSize &, bool))&D::ClassType::super_requestImage, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<-1>, cpgf::GMetaRuleCopyConstReference<0> >());
