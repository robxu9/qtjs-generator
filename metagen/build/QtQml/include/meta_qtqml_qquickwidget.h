...
void buildMetaClass_QQuickWidget(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("quickWindow", &D::ClassType::quickWindow);
...
public:
    ...
    void dragEnterEvent(QDragEnterEvent * __arg0)
    {
        ...
        QQuickWidget::dragEnterEvent(__arg0);
    }
    ...
    void dragMoveEvent(QDragMoveEvent * __arg0)
    {
        ...
        QQuickWidget::dragMoveEvent(__arg0);
    }
    ...
    void dragLeaveEvent(QDragLeaveEvent * __arg0)
    {
        ...
        QQuickWidget::dragLeaveEvent(__arg0);
    }
