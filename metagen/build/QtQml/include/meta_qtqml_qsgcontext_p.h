...
void buildMetaClass_QSGContext(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("createRectangleNode", (QSGRectangleNode * (D::ClassType::*) (const QRectF &, const QColor &))&D::ClassType::createRectangleNode, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("createRectangleNode", (QSGRectangleNode * (D::ClassType::*) ())&D::ClassType::createRectangleNode);
    _d.CPGF_MD_TEMPLATE _method("createImageNode", &D::ClassType::createImageNode);
    _d.CPGF_MD_TEMPLATE _method("createPainterNode", &D::ClassType::createPainterNode);
    _d.CPGF_MD_TEMPLATE _method("createGlyphNode", &D::ClassType::createGlyphNode);
    _d.CPGF_MD_TEMPLATE _method("createNinePatchNode", &D::ClassType::createNinePatchNode);
    _d.CPGF_MD_TEMPLATE _method("createLayer", &D::ClassType::createLayer);
...
public:
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("createNinePatchNode"));
        if(func)
        {
            return cpgf::fromVariant<QSGNinePatchNode * >(cpgf::invokeScriptFunctionOnObject(func.get(), this).getValue());
        }
        return QSGContext::createNinePatchNode();
    }
    QSGNinePatchNode * super_createNinePatchNode()
    {
        return QSGContext::createNinePatchNode();
    }
    ...
    QSGPainterNode * createPainterNode(QQuickPaintedItem * item)
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("createPainterNode"));
        if(func)
        {
            return cpgf::fromVariant<QSGPainterNode * >(cpgf::invokeScriptFunctionOnObject(func.get(), this, item).getValue());
        }
        return QSGContext::createPainterNode(item);
    }
    QSGPainterNode * super_createPainterNode(QQuickPaintedItem * item)
    {
        return QSGContext::createPainterNode(item);
    }
    ...
    QSGLayer * createLayer(QSGRenderContext * renderContext)
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("createLayer"));
        if(func)
        {
            return cpgf::fromVariant<QSGLayer * >(cpgf::invokeScriptFunctionOnObject(func.get(), this, renderContext).getValue());
        }
        return QSGContext::createLayer(renderContext);
    }
    QSGLayer * super_createLayer(QSGRenderContext * renderContext)
    {
        return QSGContext::createLayer(renderContext);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("super_createNinePatchNode", (QSGNinePatchNode * (D::ClassType::*) ())&D::ClassType::super_createNinePatchNode);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_createPainterNode", (QSGPainterNode * (D::ClassType::*) (QQuickPaintedItem *))&D::ClassType::super_createPainterNode);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_createLayer", (QSGLayer * (D::ClassType::*) (QSGRenderContext *))&D::ClassType::super_createLayer);
