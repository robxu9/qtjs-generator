...
void buildMetaClass_QQuickItem(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("grabToImage", (bool (D::ClassType::*) (const QJSValue &, const QSize &))&D::ClassType::grabToImage, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(QSize()))
    ;
    _d.CPGF_MD_TEMPLATE _method("grabToImage", (QSharedPointer< QQuickItemGrabResult > (D::ClassType::*) (const QSize &))&D::ClassType::grabToImage)
        ._default(copyVariantFromCopyable(QSize()))
    ;
    ...
    }
    {
        ...
        _nd.CPGF_MD_TEMPLATE _field("item", &QQuickItem::ItemChangeData::item, cpgf::MakePolicy<cpgf::GMetaRuleForbidWrite, cpgf::GMetaRuleForbidRead >());
        _nd.CPGF_MD_TEMPLATE _field("window", &QQuickItem::ItemChangeData::window, cpgf::MakePolicy<cpgf::GMetaRuleForbidWrite, cpgf::GMetaRuleForbidRead >());
    ...
    }
    {
        ...
        _nd.CPGF_MD_TEMPLATE _field("transformNode", &QQuickItem::UpdatePaintNodeData::transformNode, cpgf::MakePolicy<cpgf::GMetaRuleForbidWrite, cpgf::GMetaRuleForbidRead >());
        _d.CPGF_MD_TEMPLATE _class(_nd);
    }
}
