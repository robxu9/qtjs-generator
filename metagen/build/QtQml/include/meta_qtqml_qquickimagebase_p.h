...
void buildMetaClass_QQuickImageBase(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("autoTransformBaseChanged", &D::ClassType::autoTransformBaseChanged);
...
public:
    ...
    void itemChange(QQuickItem::ItemChange change, const QQuickItem::ItemChangeData & value)
    {
        ...
        QQuickImageBase::itemChange(change, value);
    }
    ...
    void setAutoTransform(bool transform)
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("setAutoTransform"));
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, transform);
            return;
        }
        QQuickImageBase::setAutoTransform(transform);
    }
    void super_setAutoTransform(bool transform)
    {
        QQuickImageBase::setAutoTransform(transform);
    }
    template <typename D>
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("super_setAutoTransform", (void (D::ClassType::*) (bool))&D::ClassType::super_setAutoTransform);
    }
};
