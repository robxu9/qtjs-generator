...
#ifndef CPGF_META_QTQML_QSGABSTRACTRENDERER_H
#define CPGF_META_QTQML_QSGABSTRACTRENDERER_H
...
template <typename D>
void buildMetaClass_QSGAbstractRenderer(D _d)
{
    (void)_d;
    ...
    _d.CPGF_MD_TEMPLATE _method("renderScene", &D::ClassType::renderScene)
    ...
    ;
    {
        GDefineMetaClass<QFlags<typename QSGAbstractRenderer::ClearModeBit > > _t_d = GDefineMetaClass<QFlags<typename QSGAbstractRenderer::ClearModeBit > >::lazyDeclare("ClearMode", &buildMetaClass_QFlags<GDefineMetaClass<QFlags<typename QSGAbstractRenderer::ClearModeBit > >, typename QSGAbstractRenderer::ClearModeBit >);
        _d._class(_t_d);
    }
}


class QSGAbstractRendererWrapper : public QSGAbstractRenderer, public cpgf::GScriptWrapper {
public:
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("nodeChanged", (void (D::ClassType::*) (QSGNode *, QSGNode::DirtyState))&D::ClassType::nodeChanged);
...
template <typename D>
void buildMetaClass_QSGAbstractRendererWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QSGAbstractRendererWrapper::cpgf__register(_d);
    
    buildMetaClass_QSGAbstractRenderer<D>(_d);
}
