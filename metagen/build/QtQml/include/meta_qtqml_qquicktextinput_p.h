...
void buildMetaClass_QQuickTextInput(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setPasswordMaskDelay", &D::ClassType::setPasswordMaskDelay);
    _d.CPGF_MD_TEMPLATE _method("resetPasswordMaskDelay", &D::ClassType::resetPasswordMaskDelay);
    ...
    _d.CPGF_MD_TEMPLATE _method("passwordMaskDelayChanged", &D::ClassType::passwordMaskDelayChanged);
