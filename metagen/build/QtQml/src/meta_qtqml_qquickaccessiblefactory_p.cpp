...
#include "QtQuick/5.5.0/QtQuick/private/qquickaccessiblefactory_p.h"

#include "meta_qtqml_qquickaccessiblefactory_p.h"
...
#endif
GDefineMetaInfo createMetaClass_Global_qquickaccessiblefactory_p()
{
    GDefineMetaGlobalDangle _d = GDefineMetaGlobalDangle::dangle();
    buildMetaClass_Global_qquickaccessiblefactory_p(_d);
