...
void buildMetaClass_QImageIOHandler(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::ImageOption>("ImageOption")
        ...
        ._element("SupportedSubTypes", D::ClassType::SupportedSubTypes)
        ._element("OptimizedWrite", D::ClassType::OptimizedWrite)
        ._element("ProgressiveScanWrite", D::ClassType::ProgressiveScanWrite)
        ._element("ImageTransformation", D::ClassType::ImageTransformation)
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::Transformation>("Transformation")
        ._element("TransformationNone", D::ClassType::TransformationNone)
        ._element("TransformationMirror", D::ClassType::TransformationMirror)
        ._element("TransformationFlip", D::ClassType::TransformationFlip)
        ._element("TransformationRotate180", D::ClassType::TransformationRotate180)
        ._element("TransformationRotate90", D::ClassType::TransformationRotate90)
        ._element("TransformationMirrorAndRotate90", D::ClassType::TransformationMirrorAndRotate90)
        ._element("TransformationFlipAndRotate90", D::ClassType::TransformationFlipAndRotate90)
        ._element("TransformationRotate270", D::ClassType::TransformationRotate270)
    ;
    {
        GDefineMetaClass<QFlags<typename QImageIOHandler::Transformation > > _t_d = GDefineMetaClass<QFlags<typename QImageIOHandler::Transformation > >::lazyDeclare("Transformations", &buildMetaClass_QFlags<GDefineMetaClass<QFlags<typename QImageIOHandler::Transformation > >, typename QImageIOHandler::Transformation >);
        _d._class(_t_d);
    }
}
