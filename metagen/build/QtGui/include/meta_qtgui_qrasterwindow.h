...
#ifndef CPGF_META_QTGUI_QRASTERWINDOW_H
#define CPGF_META_QTGUI_QRASTERWINDOW_H
...
template <typename D>
void buildMetaClass_QRasterWindow(D _d)
{
    (void)_d;
...
class QRasterWindowWrapper : public QRasterWindow, public cpgf::GScriptWrapper {
public:
    
    QRasterWindowWrapper(QWindow * parent = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QRasterWindow::qt_metacast(__arg0);
    }
    ...
    QPaintDevice * redirected(QPoint * __arg0) const
    {
        ...
        return QRasterWindow::redirected(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QRasterWindow::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QRasterWindowWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QRasterWindowWrapper::cpgf__register(_d);
    
    buildMetaClass_QRasterWindow<D>(_d);
}
