...
void buildMetaClass_QStyleHints(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("tabFocusBehavior", &D::ClassType::tabFocusBehavior);
    _d.CPGF_MD_TEMPLATE _method("singleClickActivation", &D::ClassType::singleClickActivation);
    _d.CPGF_MD_TEMPLATE _method("cursorFlashTimeChanged", &D::ClassType::cursorFlashTimeChanged);
    _d.CPGF_MD_TEMPLATE _method("keyboardInputIntervalChanged", &D::ClassType::keyboardInputIntervalChanged);
    _d.CPGF_MD_TEMPLATE _method("mouseDoubleClickIntervalChanged", &D::ClassType::mouseDoubleClickIntervalChanged);
    _d.CPGF_MD_TEMPLATE _method("startDragDistanceChanged", &D::ClassType::startDragDistanceChanged);
    _d.CPGF_MD_TEMPLATE _method("startDragTimeChanged", &D::ClassType::startDragTimeChanged);
