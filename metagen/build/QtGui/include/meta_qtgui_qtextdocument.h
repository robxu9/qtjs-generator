...
void buildMetaClass_QTextDocument(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("find", (QTextCursor (D::ClassType::*) (const QRegExp &, const QTextCursor &, QTextDocument::FindFlags) const)&D::ClassType::find, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >())
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("find", (QTextCursor (D::ClassType::*) (const QRegularExpression &, int, QTextDocument::FindFlags) const)&D::ClassType::find, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("find", (QTextCursor (D::ClassType::*) (const QRegularExpression &, const QTextCursor &, QTextDocument::FindFlags) const)&D::ClassType::find, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >())
        ._default(copyVariantFromCopyable(0))
    ;
