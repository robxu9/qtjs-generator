...
void buildMetaClass_QSurfaceFormat(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setDefaultFormat", &D::ClassType::setDefaultFormat, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::FormatOption>("FormatOption")
        ...
        ._element("ResetNotification", D::ClassType::ResetNotification)
    ;
