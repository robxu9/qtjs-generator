...
void buildMetaClass_QTabBar(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("autoHide", &D::ClassType::autoHide);
    _d.CPGF_MD_TEMPLATE _method("setAutoHide", &D::ClassType::setAutoHide);
    _d.CPGF_MD_TEMPLATE _method("changeCurrentOnDrag", &D::ClassType::changeCurrentOnDrag);
    _d.CPGF_MD_TEMPLATE _method("setChangeCurrentOnDrag", &D::ClassType::setChangeCurrentOnDrag);
