...
void buildMetaClass_QGraphicsScene(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setSelectionArea", (void (D::ClassType::*) (const QPainterPath &, Qt::ItemSelectionMode, const QTransform &))&D::ClassType::setSelectionArea, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<2> >())
        ...
        ._default(copyVariantFromCopyable(Qt::IntersectsItemShape))
    ;
    _d.CPGF_MD_TEMPLATE _method("setSelectionArea", (void (D::ClassType::*) (const QPainterPath &, Qt::ItemSelectionOperation, Qt::ItemSelectionMode, const QTransform &))&D::ClassType::setSelectionArea, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<3> >())
        ._default(copyVariantFromCopyable(QTransform()))
        ._default(copyVariantFromCopyable(Qt::IntersectsItemShape))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("minimumRenderSize", &D::ClassType::minimumRenderSize);
    _d.CPGF_MD_TEMPLATE _method("setMinimumRenderSize", &D::ClassType::setMinimumRenderSize);
