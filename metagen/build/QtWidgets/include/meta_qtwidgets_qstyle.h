...
void buildMetaClass_QStyle(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::PixelMetric>("PixelMetric")
        ...
        ._element("PM_TreeViewIndentation", D::ClassType::PM_TreeViewIndentation)
        ._element("PM_HeaderDefaultSectionSizeHorizontal", D::ClassType::PM_HeaderDefaultSectionSizeHorizontal)
        ._element("PM_HeaderDefaultSectionSizeVertical", D::ClassType::PM_HeaderDefaultSectionSizeVertical)
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::StyleHint>("StyleHint")
        ...
        ._element("SH_LineEdit_PasswordMaskDelay", D::ClassType::SH_LineEdit_PasswordMaskDelay)
        ._element("SH_TabBar_ChangeCurrentDelay", D::ClassType::SH_TabBar_ChangeCurrentDelay)
        ._element("SH_Menu_SubMenuUniDirection", D::ClassType::SH_Menu_SubMenuUniDirection)
        ._element("SH_Menu_SubMenuUniDirectionFailCount", D::ClassType::SH_Menu_SubMenuUniDirectionFailCount)
        ._element("SH_Menu_SubMenuSloppySelectOtherActions", D::ClassType::SH_Menu_SubMenuSloppySelectOtherActions)
        ._element("SH_Menu_SubMenuSloppyCloseTimeout", D::ClassType::SH_Menu_SubMenuSloppyCloseTimeout)
        ._element("SH_Menu_SubMenuResetWhenReenteringParent", D::ClassType::SH_Menu_SubMenuResetWhenReenteringParent)
        ._element("SH_Menu_SubMenuDontStartSloppyOnLeave", D::ClassType::SH_Menu_SubMenuDontStartSloppyOnLeave)
