...
void buildMetaClass_Global_qlogging(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("qFormatLogMessage", (QString (*) (QtMsgType, const QMessageLogContext &, const QString &))&qFormatLogMessage, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<2> >());
...
void buildMetaClass_QMessageLogger(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("info", (QDebug (D::ClassType::*) () const)&D::ClassType::info);
    _d.CPGF_MD_TEMPLATE _method("info", (QDebug (D::ClassType::*) (const QLoggingCategory &) const)&D::ClassType::info);
    _d.CPGF_MD_TEMPLATE _method("info", (QDebug (D::ClassType::*) (QMessageLogger::CategoryFunction) const)&D::ClassType::info);
