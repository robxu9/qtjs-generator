...
void buildMetaClass_QStandardPaths(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::StandardLocation>("StandardLocation")
        ...
        ._element("AppDataLocation", D::ClassType::AppDataLocation)
        ._element("AppConfigLocation", D::ClassType::AppConfigLocation)
        ._element("AppLocalDataLocation", D::ClassType::AppLocalDataLocation)
    ;
