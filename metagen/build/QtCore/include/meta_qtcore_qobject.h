...
void buildMetaClass_QObjectData(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _field("q_ptr", &D::ClassType::q_ptr, cpgf::MakePolicy<cpgf::GMetaRuleForbidWrite, cpgf::GMetaRuleForbidRead >());
    _d.CPGF_MD_TEMPLATE _field("parent", &D::ClassType::parent, cpgf::MakePolicy<cpgf::GMetaRuleForbidWrite, cpgf::GMetaRuleForbidRead >());
