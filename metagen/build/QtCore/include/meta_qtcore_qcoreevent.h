...
void buildMetaClass_QEvent(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::Type>("Type")
        ...
        ._element("ReadOnlyChange", D::ClassType::ReadOnlyChange)
        ...
        ._element("ScreenChangeInternal", D::ClassType::ScreenChangeInternal)
        ._element("PlatformSurface", D::ClassType::PlatformSurface)
