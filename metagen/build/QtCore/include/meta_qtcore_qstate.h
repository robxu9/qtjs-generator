...
void buildMetaClass_QState(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("childModeChanged", &D::ClassType::childModeChanged);
    _d.CPGF_MD_TEMPLATE _method("initialStateChanged", &D::ClassType::initialStateChanged);
    _d.CPGF_MD_TEMPLATE _method("errorStateChanged", &D::ClassType::errorStateChanged);
