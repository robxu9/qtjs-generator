...
void buildMetaClass_QHistoryState(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("defaultStateChanged", &D::ClassType::defaultStateChanged);
    _d.CPGF_MD_TEMPLATE _method("historyTypeChanged", &D::ClassType::historyTypeChanged);
