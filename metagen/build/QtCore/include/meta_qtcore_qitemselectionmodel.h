...
void buildMetaClass_QItemSelectionModel(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("model", (const QAbstractItemModel * (D::ClassType::*) () const)&D::ClassType::model);
    _d.CPGF_MD_TEMPLATE _method("model", (QAbstractItemModel * (D::ClassType::*) ())&D::ClassType::model);
    ...
    _d.CPGF_MD_TEMPLATE _method("modelChanged", &D::ClassType::modelChanged);
...
public:
    ...
    QItemSelectionModelWrapper(QAbstractItemModel * model = 0)
