...
public:
    ...
    void senderObjectChanged(QPrivateSignal __arg0)
    {
        QSignalTransition::senderObjectChanged(__arg0);
    }
    ...
    void signalChanged(QPrivateSignal __arg0)
    {
        QSignalTransition::signalChanged(__arg0);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("senderObjectChanged", (void (D::ClassType::*) (QPrivateSignal))&D::ClassType::senderObjectChanged);
        ...
        _d.CPGF_MD_TEMPLATE _method("signalChanged", (void (D::ClassType::*) (QPrivateSignal))&D::ClassType::signalChanged);
